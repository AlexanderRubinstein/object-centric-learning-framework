...
for key in masks.keys():
    ...
    try:
      ...
      for count in num_segments:
        if count == 0:
            continue  
        color_mask[mask==count] = colours[count]
      vis_mask = np.concatenate((image, color_mask), axis=0)
      cv2.imwrite('00001/'+key[:-4]+'_output.jpg', vis_mask)
    except:
       continue