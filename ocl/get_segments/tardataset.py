...
class TarDataset(Dataset):
  ...
  """
  def __init__(self, archive, transforms_help, extensions=('.png', '.jpg', '.jpeg'),
  ...
  def __getitem__(self, index):
    ...
    Returns:
      Tensor: The image.
    """
    inputs = self.get_image(self.samples[index])
    return inputs, self.samples[index]
